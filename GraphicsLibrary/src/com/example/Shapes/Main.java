...
public class Main {
	public static void main(String args[]) {
		...
		screen1.addShape(Shape.ShapeType.SQUARE, new Point(1,1), square1);
		screen1.addShape(Shape.ShapeType.CIRCLE, new Point(2,2), circle1) ;
		screen1.addShape(Shape.ShapeType.RECTANGLE , new Point(1,1), rectangle1);
